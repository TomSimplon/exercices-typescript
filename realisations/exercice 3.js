...
const myMan: myMan = { name: 'Marchal', surname: 'Mickeal', age: 19 };
...
const Objet: Objet = {nom: "Pustel", prenom: "Tom", age: 23};
...
const personnes: personne = [
  ...
  function exo6() {
    for (let i = 0; i < personnes.length; i++) {
      const presentation: string = `Bonjour, mon nom est ${personnes[i].nom} ${personnes[i].prenom}, j'ai ${personnes[i].age} ans.` 
